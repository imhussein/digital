<?php require_once APPROOT.'/views/admin/public/layouts/header.php'; ?>
  ...
  <div class="my-3">
    <a href="<?php echo URLROOT; ?>/admin/categories" class="btn btn-block-lg blue-grey darken-4">Back To Categories</a>
  </div>
  ...
  <div class="row">
    <div class="col m6 add-category-form">
      <div class="card">
        <form action="<?php echo URLROOT; ?>/admin/categories/edit/<?php echo $data['id']; ?>" method="POST">
          ...
          <div class="card-action">
            <input type="submit" value="Update Category" class="btn blue-grey darken-4 btn-block-lg">
          </div>
        </form>
      </div>
    </div>
