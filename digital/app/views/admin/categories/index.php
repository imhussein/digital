<?php require_once APPROOT.'/views/admin/public/layouts/header.php'; ?>
  <h2 class="flow-text center-align heading-primary blue-text ">Categories</h2>
  <?php flash('category_updated'); ?>
  <?php flash('category_added'); ?>
  <?php flash('category_deleted'); ?>
  <?php flash('category_owner_error'); ?>
        ...
        <tbody>
          <?php foreach($data['categories'] as $category): ?>
            <tr>
              ...
              <td><span class="font-bold"><?php echo $category['Category_Name'] ?></span></td>
              <td>
