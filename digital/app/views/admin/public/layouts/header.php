<?php
  ...
  if(!isset($_SESSION['userid'])){
    flash('not_autorized', 'You are not authorized to view this page', 'btn btn-message-lg red darken-4');
    redirect('users/login');
  }

  if($_SESSION['status'] == 'UnApproved'){
    flash('not_approved', 'You acount is waiting approval', 'btn btn-message-lg red darken-4');
    redirect('');
  }
...
<body>
  <?php require_once APPROOT.'/views/admin/public/layouts/navbar.php'; ?>
